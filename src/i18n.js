...
export const content = {
  es: {
    ...
    cta: {
      ...
      titleEm: 'tu proyecto.',
      sub: 'Cuéntame qué quieres construir. En menos de 24 horas te respondo con un plan claro, fechas y propuesta económica. Sin compromiso.',
      btn: 'Escríbeme ahora',
  ...
  en: {
    ...
    cta: {
      ...
      sub: 'Tell me what you want to build. In under 24 hours I reply with a clear plan, dates, and quote. No commitment.',
      btn: 'Write me now',
